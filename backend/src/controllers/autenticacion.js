...
export const validar = async (req, res) => {
    ...
    try {
        ...
        let {nombres,apellidos,correo,contraseña,rol,estado} = req.body
        let sql = `SELECT idusuario, nombres, rol FROM usuarios WHERE nombres='${nombres}', apellidos='${apellidos}, correo=' ${correo}, contraseña=${contraseña}, rol=${rol} and estado=${estado}`;
